...
* **server.xml**: Example `server.xml` configuration file for Tomcat8. This configuration file
    ...
    * Enables [access logging](http://tomcat.apache.org/tomcat-8.0-doc/config/valve.html#Access_Logging) using a custom pattern that is described at [http://www.fourproc.com/2010/06/02/improved-access-logging-format-for-labkey-server-.html](http://www.fourproc.com/2010/06/02/improved-access-logging-format-for-labkey-server-.html).
